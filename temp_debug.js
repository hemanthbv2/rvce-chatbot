...
function processNLPInput(input) {
    ...
    global.testIntent = classifyIntent; return {
        tokens: cleanTokens,
...
if (document.readyState === 'loading') {
    ...
    startRVCEChatbot();
    console.log("Intent for 'what is cse':", global.testIntent("what is cse"));
    console.log("Intent for 'cse':", global.testIntent("cse"));
