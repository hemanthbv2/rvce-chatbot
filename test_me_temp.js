...
startRVCEChatbot();
console.log("Intent for 'placement mechanical':", classifyIntent("placement mechanical"));
console.log("Intent for 'mechanical placements':", classifyIntent("mechanical placements"));
console.log("Intent for 'ise ug placements':", classifyIntent("ise ug placements"));
console.log("Intent for 'ise pg placements':", classifyIntent("ise pg placements"));

console.log("Response for plcmt_me:", getResponse('plcmt_me').text);
