...
const testCases = [
    ...
    ['Placement statistics of RVCE', 'placements_yearly', ''],
    ...
    ['Tell me about the facility', 'facilities', ''],
    ['Does the college have a canteen?', 'food', ''],
    ['Are girls hostel safe?', 'girls_hostel', ''],
    ...
    ['team ashwa', 'team_ashwa', ''],
    ['team antariksh', 'team_antariksh', ''],
    ...
    // Others
    ['postgraduate programs', 'pgPrograms', ''],
    ['undergraduate programs', 'ugPrograms', ''],
