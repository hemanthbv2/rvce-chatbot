...
global.document = { readyState: 'complete', getElementById: () => ({ addEventListener: () => {} }) };
...
console.log("Intent for CSE PLACEMENTS 2022:");
console.log(classifyIntent("CSE PLACEMENTS 2022"));
