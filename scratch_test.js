...
let idx = scriptStr.indexOf('/* =============== DOM MANIPULATION =============== */');
if (idx !== -1) {
    scriptStr = scriptStr.substring(0, idx) + appendStr + "}"; // Close the startRVCEChatbot function manually
}
...
// Run the bot wrapper to set up globals
startRVCEChatbot();
...
fs.writeFileSync('test_report.md', 
